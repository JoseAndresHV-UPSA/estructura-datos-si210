...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// tbNombre
			// 
			this->tbNombre->Location = System::Drawing::Point(273, 115);
			...
			// tbDato
			// 
			this->tbDato->Location = System::Drawing::Point(273, 89);
			...
			// btnInsertar
			// 
			this->btnInsertar->Location = System::Drawing::Point(379, 87);
			...
			// btnEliminar
			// 
			this->btnEliminar->Location = System::Drawing::Point(460, 87);
			...
			// btnInvertir
			// 
			this->btnInvertir->Location = System::Drawing::Point(93, 242);
			...
			// btnEliminarRepe
			// 
			this->btnEliminarRepe->Location = System::Drawing::Point(12, 242);
			...
			// btnLimpiar
			// 
			this->btnLimpiar->Location = System::Drawing::Point(93, 87);
			...
			// btnGuardar
			// 
			this->btnGuardar->Location = System::Drawing::Point(12, 87);
			...
			// btnTamano
			// 
			this->btnTamano->Location = System::Drawing::Point(541, 39);
			...
			// tbTamano
			// 
			this->tbTamano->Location = System::Drawing::Point(541, 13);
			...
			this->dgvC2->Location = System::Drawing::Point(12, 168);
			...
			this->dgvC1->Location = System::Drawing::Point(12, 13);
			...
			this->ClientSize = System::Drawing::Size(649, 288);
...
#pragma endregion
	...
	private: System::Void btnInvertir_Click(System::Object^ sender, System::EventArgs^ e) {
		ColaCircular aux = cola1.invertida();
		cola2.thisCola(aux);
		cola2.mostrar(dgvC2);
	}
